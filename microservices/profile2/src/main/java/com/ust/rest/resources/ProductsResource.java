...
@RestController
@RequestMapping("/product/api.2.0") //this is the base version
...
public class ProductsResource {
	 ...
	 // @ApiOperation(value="Accepts productId and Returns the product entity")
	 ...
	 // @ApiOperation(value="Returns every product entity")
	 ...
	 // @ApiOperation(value="Accept the body and will create the product entity")
...
//		}
	 ...
	 // @ApiOperation(value="Accepts the body and return the updated product entity")
	 ...
	 // @ApiOperation(value="Accepts productId and delete the product entity")
